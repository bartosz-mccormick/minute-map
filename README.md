...
- clone repository
- save a copy of `.env.example` as `.env`
- run all docker services (this will initialize the backend database and API)
...
### UPDATE API
- run `api-compliance.sql` in the database

## FRONTEND - [dreams-xmin-city-accessibility-tool-frontend](https://github.com/bartosz-mccormick/dreams-xmin-city-accessibility-tool-frontend/)
- clone repository
- - save a copy of `.env.example` as `.env`
- `npm run install`
- `npm run dev`
